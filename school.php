...
<h1 style="text-align: center; color: green">Teachers for School Section</h1>
    ...
    <?php
      ...
      $sql = "SELECT name, designation, qulificatin, photo FROM teacher WHERE section ='school' ";
    ...
    ?>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            <td scope="row"></th>
            <td><img class="card-img-top" src="<?php echo $row["photo"];?>" alt="Card image" style="width:30%"></td>
            <td><?php echo $row["name"];?></td>
            <td><?php echo $row["designation"];?></td>
            <td><?php echo $row["qulificatin"];?></td>
            <td><a href="details.php" class="btn btn-primary">See Profile</a></td>
          </tr>
