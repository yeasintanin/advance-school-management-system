...
<h1 style="text-align: center; color: green"> Details of Teachers for School Section</h1>
<?php
      ...
      if ($result->num_rows > 0) 
      {
        ...
        {
    ?>
    <img class="card-img-top" src="<?php echo $row["photo"];?>" alt="Card image" style="width:25%">
    <p>
    <?php echo $row["name"];?><br>
    <?php echo $row["designation"];?><br>
    <?php echo $row["qulificatin"];?><br>
    <?php echo $row["email"];?><br>
    <?php echo $row["gender"];?><br>
    <?php echo $row["department"];?><br>
    <?php echo $row["subject"];?><br>
    <?php echo $row["section"];?><br>
